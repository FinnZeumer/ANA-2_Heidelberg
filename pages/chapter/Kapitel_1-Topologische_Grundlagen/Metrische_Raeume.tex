...
\paragraph{Beispiele für Normen auf $\mathbb{R}^n$:}
\begin{align*}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1\textwidth]{pages/chapter/Kapitel_1-Topologische_Grundlagen/01_img/1.1/Bekannte_Metrische_Räume-Sammlung.png}
...
\paragraph{Offene und abgeschlossene Bälle:}
\begin{align*}
...
\begin{figure}[htbp]
    ...
    \begin{minipage}[t]{0.60\textwidth}
        \centering
        \includegraphics[width=\linewidth]{pages/chapter/Kapitel_1-Topologische_Grundlagen/01_img/1.1/Einheitsbälle_Tabelle.png}
    ...
    \begin{minipage}[t]{0.30\textwidth}
        \centering
        \includegraphics[width=\linewidth]{pages/chapter/Kapitel_1-Topologische_Grundlagen/01_img/1.1/Einheits_Bälle_Evolution.png}
...
\paragraph{Beispiele für Topologien:}
\begin{enumerate}
...
\begin{enumerate}
    ...
    \begin{center}
        \includegraphics[width=0.15\linewidth]{pages/chapter/Kapitel_1-Topologische_Grundlagen/01_img/1.1/Hausdorff_Ruam_Bsp01.png}
